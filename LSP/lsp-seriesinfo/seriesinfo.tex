...
\newcommand{\nc}{nc}		%Niger Congo
\newcommand{\tbls}{tbls}	%Lecture Notes in Language Sciences
...
\AtBeginDocument{
\ifx\lsSeries\eotms
	\newcommand{\lsSeriesTitle}{Big Book of Science Series}
...
\ifx\lsSeries\dummyseries
	\newcommand{\lsSeriesTitle}{Change series in localmetadata.tex~\lsSeriesNumber}
